...
module ProxyFetcher
  module Providers
    ...
    class HTTPTunnel < Base
      ...
      #   URI object
      #
      private def parse_proxy_uri(html_node)
      ...
      private def parse_country(html_node)
        img_node = html_node.find(".//img")
        img_node.attr("title") unless img_node.nil?
      end
      ...
      #   Anonymity level
      #
      private def parse_anonymity(html_node)
        transparency = html_node.content_at("td[5]")
